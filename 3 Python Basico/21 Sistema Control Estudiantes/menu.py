...
def menu_options():
    ...
    while True:
        try:
            ...
            print("4. See average score per student")
            ...
            if option_selected==1:
                ...
                actions.student_register(list_of_dictionary,list_of_headers)
            elif option_selected==2:
                print("2. Reviewing Information for all students")
                actions.students_read(list_of_dictionary,list_of_headers)
            elif option_selected==3:
                print("Seeing Top 3 students")
                actions.student_top_three_average(list_of_dictionary)
            elif option_selected==4:
                print("Seeing average score per student")
                actions.student_average(list_of_dictionary,list_of_headers)
                ...
                list_of_dictionary=actions.student_delete(list_of_dictionary,list_of_headers)
            elif option_selected==8:
                print("Seeing list of students who failed")
                actions.students_under_sixty(list_of_dictionary,list_of_headers)
